...
func (r *ReminderRepository) createToPersistence(ctx context.Context, e *entities.ReminderEntity) error {
	var (
		tx          *sql.Tx
		rollbackErr error
		err         error
	...
	err = r.reminderPersistence.CreateReminder(ctx, tx, e)
...
func (r *ReminderRepository) Create(ctx context.Context, e *entities.ReminderEntity) error {
	var err error
	...
	err = r.createToPersistence(ctx, e)
