...
func (p *ReminderPersistence) CreateReminder(ctx context.Context, tx *sql.Tx, e *entities.ReminderEntity) error {
	var (
		query string
		args  []interface{}
		err   error
	...
	query, args, err = createReminderQuery(p.cfg.RemindersSQLDB.Driver, e)
